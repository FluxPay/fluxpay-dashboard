export const address = '0x94f26B4c8AD12B18c12f38E878618f7664bdcCE2';
export const ABI = [
  {
    inputs: [
      { internalType: 'contract ISuperfluid', name: 'host', type: 'address' },
      { internalType: 'contract SuperTokenFactoryHelper', name: 'helper', type: 'address' },
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  { inputs: [{ internalType: 'uint256', name: '_code', type: 'uint256' }], name: 'ONLY_HOST', type: 'error' },
  { inputs: [{ internalType: 'uint256', name: '_code', type: 'uint256' }], name: 'ZERO_ADDRESS', type: 'error' },
  {
    anonymous: false,
    inputs: [
